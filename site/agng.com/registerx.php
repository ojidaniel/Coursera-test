                        ...
                        <div class="row row-space">
                            ...
                            <div class="col-2">
                                <div class="input-group <?php echo (!empty($birthday_err)) ? 'has-error' : ''; ?>">
                                    ...
                                    <input id="datepicker" class="input--style-2 js-datepicker" type="text" placeholder="Birthday" name="birthday" value="<?php echo $birthday; ?>" autocomplete="off" readonly onfocus="this.placeholder='Birthday'" onblur="this.placeholder='Birthday'" size=10 maxlength=10 onkeyup="this.value=this.value.replace(/^(\d\d)(\d)$/g,'$1/$2').replace(/^(\d\d\/\d\d)(\d+)$/g,'$1/$2').replace(/[^\d\/]/g,'')">
